...
#menu processing    
    ...
    def hrv_analysis_menu(self):
        ...
        mean_PPI = int(sum(self.filtered_PPI) / max(len(self.filtered_PPI),1))
        ...
        self.show_measurement_result(menu_add = ['NEXT','SAVE','HOME','END'])
    ...
    def show_mqtt_kubious_menu(self):
        self.selected_menu_item = 0
        self.menu_items = ['MQTT', 'KUBIOUS','HOME','END']
        selected_item = self.select_menu_item()
    ...
    def kubious(self):
        ...
        self.show_measurement_result(menu_add = ['SAVE','HOME','END'])
...
#show time menu - 30s, 1min, 5min
    ...
    def draw(self):
        ...
        if (self.current_bpm > self.max_bpm or self.current_bpm < self.min_bpm):
            ...
            sample_x = 1 
            for i in range(max(0, len(self.normalized_values) - self.screen_width // 3), len(self.normalized_values), 1):
